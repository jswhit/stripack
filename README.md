...
* see source code [docstrings](https://rawgit.com/jswhit/stripack/master/stripack.html), 
[``test/fib_test.py``](https://rawgit.com/jswhit/stripack/master/test/fib_test.py) for example usage.
